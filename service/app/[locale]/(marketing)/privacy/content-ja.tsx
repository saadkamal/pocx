    ...
    <LegalPage
      ...
      intro={
        <>
          ...
          （オーストラリア）が、何をなぜ収集するかを説明するものです。要約すると、当社が収集するのはアクセス制御プロダクトに必要な最小限のもの（本人確認情報、署名、アクセスイベント）だけです。データを販売することはなく、広告トラッカーも使用しません。POCXをセルフホストする場合、ここに記載される情報が当社に届くことは一切ありません。本ポリシーは日英両言語で提供され、解釈に相違がある場合は英語版が優先されます。
        </>
      }
    >
